...
* [FEATURE] Web UI: Sort alerts by group name. #5448
...
* [FEATURE] Log filesystem type on startup. #5558
...
* [ENHANCEMENT] Web: Fixed Content-Type for js and css instead of using `/etc/mime.types`. #5551
* [ENHANCEMENT] Web: Update to Bootstrap 4.3.1. #5506
* [BUGFIX] TSDB: Don't panic and recover nicely when running out of disk space. tsdb#582
...
* [BUGFIX] Discovery/kubernetes: Use `service` rather than `ingreass` as the name for the service workqueue. #5520
